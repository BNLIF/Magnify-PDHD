...
{
    // ---- Row 1: General + plane threshold groups ----
    ...
    group_nav->AddFrame(new TGLabel(group_nav, "apa: "), new TGLayoutHints(kLHintsLeft | kLHintsCenterY, 2, 2, 1, 1));
    apaCombo = new TGComboBox(group_nav, 100);
    apaCombo->Resize(80, 22);
    group_nav->AddFrame(apaCombo, new TGLayoutHints(kLHintsLeft | kLHintsCenterY, 1, 4, 1, 1));

    group_nav->AddFrame(new TGLabel(group_nav, "event: "), new TGLayoutHints(kLHintsLeft | kLHintsCenterY, 2, 2, 1, 1));
    eventCombo = new TGComboBox(group_nav, 101);
    eventCombo->Resize(120, 22);
    group_nav->AddFrame(eventCombo, new TGLayoutHints(kLHintsLeft | kLHintsCenterY, 1, 4, 1, 1));

    prevEvtButton = new TGTextButton(group_nav, "  <  ");
    group_nav->AddFrame(prevEvtButton, new TGLayoutHints(kLHintsLeft | kLHintsCenterY, 2, 2, 2, 2));

    nextEvtButton = new TGTextButton(group_nav, "  >  ");
    group_nav->AddFrame(nextEvtButton, new TGLayoutHints(kLHintsLeft | kLHintsCenterY, 2, 2, 2, 2));
