# Magnify-protodune: Architecture
...
The current deployment targets **ProtoDUNE Single-Phase / Horizontal Drift (HD)**: 6 APAs × 2560 channels per APA = 15 360 total channels, 6000 time ticks, planes U/V/W (800 + 800 + 960 ch/APA).
